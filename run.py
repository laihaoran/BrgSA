...
def main(cfg, args):
    ...
    # # 如果 cfg.continuing 为 True 且提供了 checkpoint 路径
    # if cfg.train.continuing:
    #     ckpt_path = cfg.train.continuing
    # device = "cuda" if torch.cuda.is_available() else "cpu"
    # #     print(f"Loading checkpoint from {ckpt_path}...")
    # ckpt = torch.load('/haoranlai/Project/gloria/data/ckpt/3D_CLIP_text_5_16_1.0_image_vitb768_M3AE2_text_M3AE2_proj_norm_bert_F_dictionary_Loss_1_0.5_0.5_with_GPT4Modify_1.0/2024_11_28_01_48_50/last.ckpt', map_location=device)
