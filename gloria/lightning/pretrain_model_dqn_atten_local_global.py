...
class PretrainDQNIINLOCALGLOBALModel(LightningModule):
    def __init__(self, cfg):
        super().__init__()

        self.cfg = cfg
        self.save_hyperparameters(self.cfg)
        self.gloria = builder.build_gloria_dqn_atten_local_global_model(cfg)
    ...
    def shared_step(self, batch, split):
        ...
        img_emb_l, img_emb_g, text_emb_l, text_emb_g, sents, i2t_cls, t2i_cls, i2t_l_cls, t2i_l_cls, i2t_g_cls,t2i_g_cls = self.gloria(batch)
        loss = self.gloria.calc_loss(
            img_emb_l, img_emb_g, text_emb_l, text_emb_g, sents, i2t_cls, t2i_cls, i2t_l_cls, t2i_l_cls, i2t_g_cls,t2i_g_cls
        )
