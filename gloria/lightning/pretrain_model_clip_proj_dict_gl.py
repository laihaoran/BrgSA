...
class PretrainCLIPProjDictGLModel(LightningModule):
    def __init__(self, cfg):
        super().__init__()

        self.cfg = cfg
        self.save_hyperparameters(self.cfg)
        self.gloria = builder.build_CLIP_proj_dict_gl_model(cfg)
    ...
    def shared_step(self, batch, split):
        ...
        img_emb_g_recon, img_emb_g, img_emb_l_recon, img_emb_l, text_emb_g_recon, text_emb_g, text_emb_l_recon, text_emb_l, sents = self.gloria(batch)
        loss = self.gloria.calc_loss(
           img_emb_g_recon, img_emb_g, img_emb_l_recon, img_emb_l, text_emb_g_recon, text_emb_g, text_emb_l_recon, text_emb_l, sents
        )
