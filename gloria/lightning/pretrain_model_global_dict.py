...
class PretrainGlobalDictModel(LightningModule):
    def __init__(self, cfg):
        super().__init__()

        self.cfg = cfg
        self.save_hyperparameters(self.cfg)
        self.gloria = builder.build_goria_dict_model(cfg)
    ...
    def shared_step(self, batch, split):
        ...
        img_emb_g_recon, img_z, img_emb_g, text_emb_g_recon, text_z, text_emb_g, sents = self.gloria(batch)
        loss = self.gloria.calc_loss(
            img_emb_g_recon, img_z, img_emb_g, text_emb_g_recon, text_z, text_emb_g, sents
        )
