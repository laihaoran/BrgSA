...
class PretrainDQNWOSAGLWOHProjCOSModel(LightningModule):
    def __init__(self, cfg):
        ...
        self.gloria = builder.build_gloria_dqn_wo_self_atten_gl_wo_head_cos_proj_model(cfg)
    ...
    def shared_step(self, batch, split):
        ...
        img_emb_l, img_emb_g, text_emb_l, text_emb_g, sents, proj_img, proj_text = self.gloria(batch)
