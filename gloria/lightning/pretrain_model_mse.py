...
class PretrainMSEModel(LightningModule):
    def __init__(self, cfg):
        super().__init__()

        self.cfg = cfg
        self.save_hyperparameters(self.cfg)
        self.gloria = builder.build_CLIP_dict_mse_model(cfg)
    ...
    def shared_step(self, batch, split):
        ...
        img_emb_g_recon, img_emb_g, z = self.gloria(batch)
        loss = self.gloria.calc_loss(
            img_emb_g_recon, img_emb_g, z
        )
