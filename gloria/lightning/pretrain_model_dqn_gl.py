...
class PretrainDQNGLModel(LightningModule):
    def __init__(self, cfg):
        super().__init__()

        self.cfg = cfg
        self.save_hyperparameters(self.cfg)
        self.gloria = builder.build_gloria_dqngl_model(cfg)
    ...
    def shared_step(self, batch, split):
        ...
        img_emb_l, img_emb_g, text_emb_l, text_emb_g, sents, il_2_tg_cls, tl_2_ig_cls = self.gloria(batch)
        loss = self.gloria.calc_loss(
            img_emb_l, img_emb_g, text_emb_l, text_emb_g, sents, il_2_tg_cls, tl_2_ig_cls, split
        )
