...
class GLoRIADQNWOSA(nn.Module):
    def __init__(self, cfg):
        super(GLoRIADQNWOSA, self).__init__()
    ...
    def process_3D_data(self, paths, device):
        transform = builder.build_transformation_3D(self.cfg, split="test")
