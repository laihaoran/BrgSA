...
class CLIPProjDictAdd(nn.Module):
    def __init__(self, cfg):
        super(CLIPProjDictAdd, self).__init__()
    ...
    def forward(self, x):
        ...
        # 
        img_emb_g_recon = self.dictionarylearning(img_emb_g, norm=True)
        text_emb_g_recon = self.dictionarylearning(text_emb_g, norm=True)

        img_emb_g = img_emb_g + img_emb_g_recon
        text_emb_g = text_emb_g + text_emb_g_recon
