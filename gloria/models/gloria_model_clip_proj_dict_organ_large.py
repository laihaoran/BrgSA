...
class CLIPProjDictOrganLarge(nn.Module):
    def __init__(self, cfg):
        super(CLIPProjDictOrganLarge, self).__init__()
    ...
    def forward(self, x):
        # logit
        # tokenizer image
        # extract 224x224x112 for total image, ogran token from 256x256x128
        ...
        # calculate the global text token
        ...
        # calculate the local image token
