...
class CLIPProjGLDict(nn.Module):
    def __init__(self, cfg):
        super(CLIPProjGLDict, self).__init__()
    ...
    def calc_loss(self, img_emb_g_recon, img_emb_g, img_emb_l_recon, img_emb_l, text_emb_g_recon, text_emb_g, text_emb_l_recon, text_emb_l, sents):
        ...
        # reconstruction loss
        img_recon_loss = F.mse_loss(img_emb_g_recon, img_emb_g) + F.mse_loss(img_emb_l_recon, img_emb_l)
        text_recon_loss = F.mse_loss(text_emb_g_recon, text_emb_g) + F.mse_loss(text_emb_l_recon, text_emb_l)
    ...
    def forward(self, x):
        ...
        # squence local feature
        img_emb_l = img_emb_l.view(-1, img_emb_l.shape[-1])
        ...
        # 
        text_emb_l = text_emb_l.permute(0, 2, 1)
        text_emb_l = text_emb_l.contiguous().view(-1, text_emb_l.shape[-1])

        img_emb_g_recon = self.dictionarylearning(img_emb_g)
        text_emb_g_recon = self.dictionarylearning(text_emb_g)

        img_emb_l_recon = self.dictionarylearning(img_emb_l)
        text_emb_l_recon = self.dictionarylearning(text_emb_l)



        return img_emb_g_recon, img_emb_g, img_emb_l_recon, img_emb_l, text_emb_g_recon, text_emb_g, text_emb_l_recon, text_emb_l, sents
