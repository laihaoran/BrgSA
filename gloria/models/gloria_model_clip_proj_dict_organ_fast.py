...
class CLIPProjDictOrganFast(nn.Module):
    def __init__(self, cfg):
        super(CLIPProjDictOrganFast, self).__init__()
    ...
    def forward(self, x):
        ...
        return img_emb_g, img_emb_g_recon, all_organ_img_features, all_organ_img_features_recon, text_emb_g, text_emb_g_recon,  all_organ_text_features, all_organ_text_features_recon, sents
