...
class GLoRIADQNWOSAG(nn.Module):
    def __init__(self, cfg):
        super(GLoRIADQNWOSAG, self).__init__()
    ...
    def forward(self, x):
        ...
        img_emb_g_ = img_emb_g.unsqueeze(1) # [512, 768] -> [512, 1, 768]
        # 

        i2t_cls = self.fusion_module(img_emb_g_, text_emb_g).squeeze(-1)
        ...
        text_emb_g_ = text_emb_g.unsqueeze(1) # [512, 768] -> [512, 1, 768]

        t2i_cls = self.fusion_module(text_emb_g_, img_emb_g).squeeze(-1)
