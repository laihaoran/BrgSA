...
class CLIPProjDQN(nn.Module):
    def __init__(self, cfg):
        super(CLIPProjDQN, self).__init__()
    ...
    def forward(self, x):
        ...
        # 
        # img_emb_l_ = img_emb_l.permute(0, 2, 1) 

        i2t_cls = self.fusion_module(torch.cat([img_emb_g.unsqueeze(1) , img_emb_l], dim=1) , text_emb_g).squeeze(-1)
