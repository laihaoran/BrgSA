...
class GLoRIAIINATTL(nn.Module):
    def __init__(self, cfg):
        super(GLoRIAIINATTL, self).__init__()
    ...
    def calc_loss(self, img_emb_l, img_emb_g, text_emb_l, text_emb_g, sents, i2t_cls, t2i_cls, i2t_g_cls, t2i_g_cls):
    ...
    def forward(self, x):
        ...
        img_atten = (img_atten[-4] +img_atten[-3]+img_atten[-2]+img_atten[-1])/4
        text_atten = (text_atten[-4] +text_atten[-3]+text_atten[-2]+text_atten[-1])/4
        ...
        return img_emb_l, img_emb_g, text_emb_l, text_emb_g, sents, i2t_cls, t2i_cls, i2t_l_cls, t2i_l_cls
