...
class IINS_Model(nn.Module):
    ...
    def forward(self, image_features, text_features, pos=None, return_atten = False, mode='local'):
        if mode == 'local':
            ...
            # image_features = image_features.unsqueeze(1).repeat(1, batch_size, 1) # (batch_size, batch_size,dim)
