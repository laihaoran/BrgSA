...
class GLoRIADQNIIN(nn.Module):
    def __init__(self, cfg):
        super(GLoRIADQNIIN, self).__init__()
        ...
        self.fusion_module_global = builder.build_iin_module(cfg)
    ...
    def forward(self, x):
        ...
        i2t_g_cls = self.fusion_module_global(img_emb_g, text_emb_g).squeeze(-1)
        t2i_g_cls = self.fusion_module_global(text_emb_g, img_emb_g).squeeze(-1)
