...
class CLIPProjKMB(nn.Module):
    def __init__(self, cfg):
        super(CLIPProjKMB, self).__init__()
    ...
    def calc_loss(self, img_emb_g_recon, img_emb_g, text_emb_g_recon, text_emb_g, sents):
        ...
        # test 2
        # text_emb_g_recon = (text_emb_g + text_emb_g) / 2
        ...
        # global loss
        g_loss0, g_loss1 = self._calc_global_loss(img_emb_g, text_emb_g_recon)
        ...
        loss += ( img_recon_loss ) * self.mse_loss_weight
