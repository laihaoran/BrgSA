...
class GLoRIADQND(nn.Module):
    def __init__(self, cfg):
        super(GLoRIADQND, self).__init__()
        ...
        self.fusion_module1 = builder.build_dqn_module(cfg)
    ...
    def forward(self, x):
        ...
        i2t_cls = self.fusion_module(img_emb_l_, text_emb_g, pos=self.img_encoder.model.pos_embed[:, 1:, :].transpose(0,1)).squeeze(-1)
        #
        ...
        # 
        t2i_cls = self.fusion_module1(text_emb_l_, img_emb_g).squeeze(-1)
