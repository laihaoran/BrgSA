...
class UniversalCXRPS(nn.Module):
    def __init__(self, cfg):
        super(UniversalCXRPS, self).__init__()
        ...
        self.ce_loss = loss.MaskError_loss.MaskErrorLoss()
    ...
    def calc_loss(self, img_emb_l, img_emb_g, text_emb_l, text_emb_g, sents, cls, label, split='train'):
    ...
    def forward(self, x):
        ...
        return img_emb_l, img_emb_g, text_emb_l, text_emb_g, sents, cls
